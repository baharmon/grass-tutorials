...
code-links:
  - text: Download the Jupyter notebook
    href: map_algebra.ipynb
    icon: file-code
    target: _blank
resources: map_algebra.ipynb
format:
  html:
    toc: true
    code-tools: true
...
| Types  | Scope                          |
|--------|--------------------------------|
| Local  | Each cell individually         |
| Focal  | Each cell and its neighborhood |
| Zonal  | Groups of cells                |
| Global | All cells                      |
...
# Constants
In this tutorial, we will be modeling a landscape, 
