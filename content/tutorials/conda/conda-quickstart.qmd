...
The GRASS Python package
for {{< fa brands microsoft >}} Windows is coming soon!
In the meantime, try the package for Windows Subsystem for Linux instead.
...
session = gj.init(Path.cwd() / "natural_earth_dataset")
